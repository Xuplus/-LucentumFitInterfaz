...
public class Ranking extends AppCompatActivity {
    ...
    private String urlPersonal="http://46.101.84.36:80/ranking/Personal/"; //+id
    private String urlAmigos="http://46.101.84.36:80/ranking/"; //+id
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SimpleAdapter simpleAdapter = new SimpleAdapter(this, rankingList, android.R.layout.simple_list_item_1, new String[] {"country"}, new int[] {android.R.id.text1});
    ...
    private void initList(String s){
        ...
        try{
            ...
            for(int i = 0; i<jsonMainNode.length();i++){
                ...
                rankingList.add(createEmployee("country", outPut));
            }
